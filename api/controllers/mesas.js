...
exports.mesas_get_all = async (req, res, next) => {
  try {
...
exports.mesas_get_mesa = async (req, res, next) => {
  try {
...
exports.mesas_create_mesa = async (req, res, next) => {
  try {
...
exports.mesas_update_mesa = async (req, res, next) => {
  try {
    const id = req.params.mesaId;
    const updateOps = {};
...
exports.mesas_delete_mesa = async (req, res, next) => {
  try {
    const id = req.params.mesaId;
